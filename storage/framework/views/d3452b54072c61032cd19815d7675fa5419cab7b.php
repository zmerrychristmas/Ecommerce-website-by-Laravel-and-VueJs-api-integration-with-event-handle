...
<div id="horizon" v-cloak>
    ...
    <div class="container mb-5">
        <div class="d-flex align-items-center py-4 header">
            ...
            <h4 class="mb-0 ml-2">
                <strong>Laravel</strong> Horizon<?php echo e(config('app.name') ? ' - ' . config('app.name') : ''); ?></h4>
...
<?php /**PATH /var/www/html/vendor/laravel/horizon/src/../resources/views/layout.blade.php ENDPATH**/ ?>